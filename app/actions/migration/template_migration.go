...
func createMigrationPlaceholderMap() map[string]string {
	return map[string]string{
		...
		"##JENKINS_MASTER_DEFAULT_LABEL##":                   "{{ .JenkinsHelmValues.Master.CustomJenkinsLabels }}",
		...
		"##JENKINS_MASTER_CONTAINER_IMAGE##":                  "{{ .JenkinsHelmValues.Master.Image }}",
		"##JENKINS_MASTER_CONTAINER_IMAGE_TAG##":              "{{ .JenkinsHelmValues.Master.Tag }}",
		"##JENKINS_MASTER_CONTAINER_PULL_POLICY##":            "{{ .JenkinsHelmValues.Master.ImagePullPolicy }}",
		"##JENKINS_MASTER_CONTAINER_IMAGE_PULL_SECRET_NAME##": "{{ .JenkinsHelmValues.Master.ImagePullSecretName }}",
		"##JENKINS_MASTER_DENY_ANONYMOUS_READ_ACCESS##":       "{{ .JenkinsHelmValues.Master.AuthorizationStrategyDenyAnonymousReadAccess }}",
		"##JENKINS_MASTER_ADMIN_PASSWORD##":                   "{{ .JenkinsHelmValues.Master.AdminPassword }}",
		"##JENKINS_JCASC_CONFIGURATION_URL##":                 "{{ .JenkinsHelmValues.Master.SidecarsConfigAutoReloadFolder }}",
